...
import { defaultChatPanePayload, defaultStreamCppPayload } from "./constants";
import {
  CURSOR_BEARER_TOKEN,
...
import type { StreamUnifiedChatRequestWithTools } from "./types/proto";
...
async function sendStreamUnifiedChatRequest(
  ...
  newPayload.currentFile.contents = message;
